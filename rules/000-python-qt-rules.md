...
- Handlers extend `core.Observer.Subscriber` and implement event logic (`on<event_name_camel_case>` methods). Keep business logic out of controllers.
...
## 6) Testing
- Use the provided pytest setup in `tests/` (see `TESTING_SETUP.md`).
